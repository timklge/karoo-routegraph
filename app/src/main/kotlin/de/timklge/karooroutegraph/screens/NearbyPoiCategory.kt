...
enum class NearbyPoiCategory(val labelRes: Int, val osmTag: List<Pair<String, String>>, val hhType: String) {
    ...
    CONVENIENCE_STORE(R.string.category_convenience_store, listOf("shop" to "convenience"), Symbol.POI.Types.CONVENIENCE_STORE),
    BIKE_PARKING(R.string.category_bike_parking, listOf("amenity" to "bicycle_parking"), Symbol.POI.Types.BIKE_PARKING),
    PUBLIC_BATH(R.string.category_public_bath, listOf("amenity" to "public_bath", "leisure" to "bathing_place"), Symbol.POI.Types.RESTROOM),
    ...
    LAUNDRY(R.string.category_laundry, listOf("amenity" to "washing_machine", "shop" to "laundry"), Symbol.POI.Types.GENERIC),
